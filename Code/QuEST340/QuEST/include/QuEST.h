...
#if defined(WIN64)
#   if !defined(QUESTAPI)
#        define __LIB_TITLE__    "QuEST"
#       ifdef _QUEST_PRIVATE
#           define QUESTAPI __declspec(dllexport)
#       else
#           define QUESTAPI __declspec(dllimport)
#       endif
#       ifndef _QUEST_PRIVATE
#           ifdef DEBUG
 ...
 * @author Ania Brown
 */
typedef struct QUESTAPI ComplexArray
{
    qreal *real; 
    qreal *imag;
} ComplexArray;
 ...
 * @author Ania Brown
 */
typedef struct QUESTAPI Complex
{
    qreal real;
    qreal imag;
} Complex;
 ...
 */
typedef struct QUESTAPI ComplexMatrix2
{
    qreal real[2][2];
    qreal imag[2][2];
} ComplexMatrix2;
 ...
 * @author Tyson Jones (doc)
 */
typedef struct QUESTAPI ComplexMatrix4
{
    qreal real[4][4];
    qreal imag[4][4];
} ComplexMatrix4;
  ...
  * @author Tyson Jones
  */
typedef struct QUESTAPI ComplexMatrixN
{
  int numQubits;
  qreal **real;
  qreal **imag;
 ...
 * @author Ania Brown
 */
typedef struct QUESTAPI Vector
{
    qreal x, y, z;
} Vector;
 ...
 * @author Tyson Jones
 */
typedef struct QUESTAPI PauliHamil 
{
 ...
 * @author Tyson Jones 
 */
typedef struct QUESTAPI DiagonalOp
{
 ...
 */
typedef struct QUESTAPI QuESTEnv
{
    int rank;
    int numRanks;
 ...
 */
Qureg QUESTAPI createQureg(int numQubits, QuESTEnv env);
 ...
 * @author Tyson Jones
 */
Qureg QUESTAPI createDensityQureg(int numQubits, QuESTEnv env);
 ...
 * @author Tyson Jones
 */
Qureg QUESTAPI createCloneQureg(Qureg qureg, QuESTEnv env);
 ...
 */
void QUESTAPI destroyQureg(Qureg qureg, QuESTEnv env);
 ...
 * > to create a ComplexMatrixN struct QUESTAPI in the stack (which doesn't need to be later destroyed),
 ...
 * @returns a dynamic ComplexMatrixN struct QUESTAPI, that is one where the .real and .imag
 ...
 * @author Tyson Jones
 */
ComplexMatrixN QUESTAPI createComplexMatrixN(int numQubits);
 ...
 * @author Tyson Jones
 */
void QUESTAPI destroyComplexMatrixN(ComplexMatrixN matr);
 ...
 * @author Tyson Jones
 */
void QUESTAPI initComplexMatrixN(ComplexMatrixN m, qreal real[][1<<m.numQubits], qreal imag[][1<<m.numQubits]);
#endif
#endif
 ...
 * @returns a dynamic \p PauliHamil struct QUESTAPI, with fields \p pauliCodes and \p termCoeffs stored in the heap
 * @throws invalidQuESTInputError()
 * - if \p numQubits <= 0
 * - if \p numSumTerms <= 0
 * @author Tyson Jones
 */
PauliHamil QUESTAPI createPauliHamil(int numQubits, int numSumTerms);
 ...
 * @author Tyson Jones
 */
void QUESTAPI destroyPauliHamil(PauliHamil hamil);
 ...
 * @author Tyson Jones
 */
void QUESTAPI initPauliHamil(PauliHamil hamil, qreal* coeffs, enum pauliOpType* codes);
 ...
 * @author Tyson Jones
 */
DiagonalOp QUESTAPI createDiagonalOp(int numQubits, QuESTEnv env);
 ...
 * @author Tyson Jones
 */
void QUESTAPI destroyDiagonalOp(DiagonalOp op, QuESTEnv env);
 ...
 * @author Tyson Jones
 */
void QUESTAPI syncDiagonalOp(DiagonalOp op);
 ...
 * @author Tyson Jones
 */
void QUESTAPI initDiagonalOp(DiagonalOp op, qreal* real, qreal* imag);
 ...
 */
void QUESTAPI initDiagonalOpFromPauliHamil(DiagonalOp op, PauliHamil hamil);
 ...
 * @author Milos Prokop (serial prototype)
 */ 
DiagonalOp QUESTAPI createDiagonalOpFromPauliHamilFile(char* fn, QuESTEnv env);
 ...
 * @author Tyson Jones
 */
void QUESTAPI setDiagonalOpElems(DiagonalOp op, long long int startInd, qreal* real, qreal* imag, long long int numElems);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyDiagonalOp(Qureg qureg, DiagonalOp op);
 ...
 * @author Tyson Jones
 */
Complex QUESTAPI calcExpecDiagonalOp(Qureg qureg, DiagonalOp op);
 ...
 * @author Ania Brown
 */
void QUESTAPI reportState(Qureg qureg);
 ...
 * @author Ania Brown
 */
void QUESTAPI reportStateToScreen(Qureg qureg, QuESTEnv env, int reportRank);
 ...
 * @author Ania Brown
 */
void QUESTAPI reportQuregParams(Qureg qureg);
 ...
 * @author Tyson Jones
 */ 
void QUESTAPI reportPauliHamil(PauliHamil hamil);
 ...
 * @author Tyson Jones
 */
int QUESTAPI getNumQubits(Qureg qureg);
 ...
 * @author Tyson Jones
 */
long long int QUESTAPI getNumAmps(Qureg qureg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI initBlankState(Qureg qureg);
 ...
 */
void QUESTAPI initZeroState(Qureg qureg);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI initPlusState(Qureg qureg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI initClassicalState(Qureg qureg, long long int stateInd);
 ...
 * @author Tyson Jones
 */
void QUESTAPI initPureState(Qureg qureg, Qureg pure);
 ...
 * @author Tyson Jones (doc)
 */
void QUESTAPI initDebugState(Qureg qureg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI initStateFromAmps(Qureg qureg, qreal* reals, qreal* imags);
 ...
 * @author Tyson Jones
 */
void QUESTAPI setAmps(Qureg qureg, long long int startInd, qreal* reals, qreal* imags, long long int numAmps);
 ...
 * @author Tyson Jones
 */
void QUESTAPI setDensityAmps(Qureg qureg, long long int startRow, long long int startCol, qreal* reals, qreal* imags, long long int numAmps);
 ...
 * @author Tyson Jones
 */
void QUESTAPI cloneQureg(Qureg targetQureg, Qureg copyQureg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI phaseShift(Qureg qureg, int targetQubit, qreal angle);
 ...
 * @author Tyson Jones
 */
void QUESTAPI controlledPhaseShift(Qureg qureg, int idQubit1, int idQubit2, qreal angle);
 ...
 * @author Tyson Jones
 */
void QUESTAPI multiControlledPhaseShift(Qureg qureg, int *controlQubits, int numControlQubits, qreal angle);
 ...
 * @author Tyson Jones
 */
void QUESTAPI controlledPhaseFlip (Qureg qureg, int idQubit1, int idQubit2);
 ...
 * @author Tyson Jones
 */
void QUESTAPI multiControlledPhaseFlip(Qureg qureg, int *controlQubits, int numControlQubits);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI sGate(Qureg qureg, int targetQubit);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI tGate(Qureg qureg, int targetQubit);
 ...
 * @author Ania Brown
 */
QuESTEnv QUESTAPI createQuESTEnv(void);
 ...
 * @author Ania Brown
 */
void QUESTAPI destroyQuESTEnv(QuESTEnv env);
 ...
 * @author Ania Brown
 */
void QUESTAPI syncQuESTEnv(QuESTEnv env);
 ...
 * @author Ania Brown
 */
void QUESTAPI reportQuESTEnv(QuESTEnv env);
 ...
 * @author Tyson Jones
 */
void QUESTAPI getEnvironmentString(QuESTEnv env, char str[200]);
 ...
 * @author Tyson Jones (doc)
 */
void QUESTAPI copyStateToGPU(Qureg qureg);
 ...
 * @author Tyson Jones (doc)
 */
void QUESTAPI copyStateFromGPU(Qureg qureg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI copySubstateToGPU(Qureg qureg, long long int startInd, long long int numAmps);
 ...
 * @author Tyson Jones
 */
void QUESTAPI copySubstateFromGPU(Qureg qureg, long long int startInd, long long int numAmps);
 ...
 * @return amplitude at index, returned as a Complex struct QUESTAPI (with .real and .imag attributes)
 * @throws invalidQuESTInputError()
 * - if \p qureg is a density matrix
 * - if \p index is outside [0, \f$2^{N}\f$) where \f$N = \f$ \p qureg.numQubitsRepresented
 * @author Tyson Jones
 */
Complex QUESTAPI getAmp(Qureg qureg, long long int index);
 ...
 * @author Ania Brown
 */
qreal QUESTAPI getRealAmp(Qureg qureg, long long int index);
 ...
 * @author Ania Brown
 */
qreal QUESTAPI getImagAmp(Qureg qureg, long long int index);
 ...
 * @author Ania Brown
 */
qreal QUESTAPI getProbAmp(Qureg qureg, long long int index);
 ...
 * @author Tyson Jones
 */
Complex QUESTAPI getDensityAmp(Qureg qureg, long long int row, long long int col);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
qreal QUESTAPI calcTotalProb(Qureg qureg);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI compactUnitary(Qureg qureg, int targetQubit, Complex alpha, Complex beta);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI unitary(Qureg qureg, int targetQubit, ComplexMatrix2 u);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI rotateX(Qureg qureg, int rotQubit, qreal angle);
 ...
 */
void QUESTAPI rotateY(Qureg qureg, int rotQubit, qreal angle);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI rotateZ(Qureg qureg, int rotQubit, qreal angle);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI rotateAroundAxis(Qureg qureg, int rotQubit, qreal angle, Vector axis);
 ...
 * @author Tyson Jones
 */
void QUESTAPI controlledRotateX(Qureg qureg, int controlQubit, int targetQubit, qreal angle);
 ...
 * @author Tyson Jones
 */
void QUESTAPI controlledRotateY(Qureg qureg, int controlQubit, int targetQubit, qreal angle);
 ...
 * @author Tyson Jones
 */
void QUESTAPI controlledRotateZ(Qureg qureg, int controlQubit, int targetQubit, qreal angle);
 ...
 * @author Tyson Jones
 */
void QUESTAPI controlledRotateAroundAxis(Qureg qureg, int controlQubit, int targetQubit, qreal angle, Vector axis);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI controlledCompactUnitary(Qureg qureg, int controlQubit, int targetQubit, Complex alpha, Complex beta);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI controlledUnitary(Qureg qureg, int controlQubit, int targetQubit, ComplexMatrix2 u);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI multiControlledUnitary(Qureg qureg, int* controlQubits, int numControlQubits, int targetQubit, ComplexMatrix2 u);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI pauliX(Qureg qureg, int targetQubit);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI pauliY(Qureg qureg, int targetQubit);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI pauliZ(Qureg qureg, int targetQubit);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI hadamard(Qureg qureg, int targetQubit);
 ...
 * @author Tyson Jones (density matrix, doc)
 */
void QUESTAPI controlledNot(Qureg qureg, int controlQubit, int targetQubit);
 ...
 * @author Tyson Jones
 */
void QUESTAPI multiControlledMultiQubitNot(Qureg qureg, int* ctrls, int numCtrls, int* targs, int numTargs);
 ...
 * @author Tyson Jones
 */
void QUESTAPI multiQubitNot(Qureg qureg, int* targs, int numTargs);
 ...
 */
void QUESTAPI controlledPauliY(Qureg qureg, int controlQubit, int targetQubit);
 ...
 * @author Tyson Jones (density matrix)
 */
qreal QUESTAPI calcProbOfOutcome(Qureg qureg, int measureQubit, int outcome);
 ...
 * @author Tyson Jones
 */
void QUESTAPI calcProbOfAllOutcomes(qreal* outcomeProbs, Qureg qureg, int* qubits, int numQubits);
 ...
 * @author Tyson Jones (density matrix)
 */
qreal QUESTAPI collapseToOutcome(Qureg qureg, int measureQubit, int outcome);
 ...
 * @author Tyson Jones (density matrix)
 */
int QUESTAPI measure(Qureg qureg, int measureQubit);
 ...
 * @author Tyson Jones (density matrix)
 */
int QUESTAPI measureWithStats(Qureg qureg, int measureQubit, qreal *outcomeProb);
 ...
 * @author Tyson Jones
 */
Complex QUESTAPI calcInnerProduct(Qureg bra, Qureg ket);
 ...
 */
qreal QUESTAPI calcDensityInnerProduct(Qureg rho1, Qureg rho2);
 ...
 * @author Tyson Jones (doc)
 **/
void QUESTAPI seedQuESTDefault(QuESTEnv *env);
 ...
 * @author Tyson Jones (doc)
 **/
void QUESTAPI seedQuEST(QuESTEnv *env, unsigned long int *seedArray, int numSeeds);
 ...
 * @author Tyson Jones
 **/
void QUESTAPI getQuESTSeeds(QuESTEnv env, unsigned long int** seeds, int* numSeeds);
 ...
 * @author Tyson Jones
 */
void QUESTAPI startRecordingQASM(Qureg qureg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI stopRecordingQASM(Qureg qureg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI clearRecordedQASM(Qureg qureg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI printRecordedQASM(Qureg qureg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI writeRecordedQASMToFile(Qureg qureg, char* filename);
 ...
 */
void QUESTAPI mixDephasing(Qureg qureg, int targetQubit, qreal prob);
 ...
 * @author Ania Brown (CPU, distributed)
 */
void QUESTAPI mixTwoQubitDephasing(Qureg qureg, int qubit1, int qubit2, qreal prob);
 ...
 * @author Ania Brown (CPU, distributed)
 */
void QUESTAPI mixDepolarising(Qureg qureg, int targetQubit, qreal prob);
 ...
 */
void QUESTAPI mixDamping(Qureg qureg, int targetQubit, qreal prob);
 ...
 * @author Ania Brown (CPU, distributed)
 */
void QUESTAPI mixTwoQubitDepolarising(Qureg qureg, int qubit1, int qubit2, qreal prob);
 ...
 */
void QUESTAPI mixPauli(Qureg qureg, int targetQubit, qreal probX, qreal probY, qreal probZ);
 ...
 * @author Tyson Jones
 */
void QUESTAPI mixDensityMatrix(Qureg combineQureg, qreal prob, Qureg otherQureg);
 ...
 * @author Tyson Jones
 */
qreal QUESTAPI calcPurity(Qureg qureg);
 ...
 * @author Tyson Jones
 */
qreal QUESTAPI calcFidelity(Qureg qureg, Qureg pureState);
 ...
 * @author Tyson Jones
 */
void QUESTAPI swapGate(Qureg qureg, int qubit1, int qubit2);
 ...
 * @author Tyson Jones
 */
void QUESTAPI sqrtSwapGate(Qureg qureg, int qb1, int qb2);
 ...
 * @author Tyson Jones
 */
void QUESTAPI multiStateControlledUnitary(Qureg qureg, int* controlQubits, int* controlState, int numControlQubits, int targetQubit, ComplexMatrix2 u);
 ...
 * @author Tyson Jones
 */
void QUESTAPI multiRotateZ(Qureg qureg, int* qubits, int numQubits, qreal angle);
 ...
 * @author Tyson Jones
 */
void QUESTAPI multiRotatePauli(Qureg qureg, int* targetQubits, enum pauliOpType* targetPaulis, int numTargets, qreal angle);
 ...
 * @author Tyson Jones
 */
void QUESTAPI multiControlledMultiRotateZ(Qureg qureg, int* controlQubits, int numControls, int* targetQubits, int numTargets, qreal angle);
 ...
 * @author Tyson Jones
 */
void QUESTAPI multiControlledMultiRotatePauli(Qureg qureg, int* controlQubits, int numControls, int* targetQubits, enum pauliOpType* targetPaulis, int numTargets, qreal angle);
 ...
 * @author Tyson Jones
 */
qreal QUESTAPI calcExpecPauliProd(Qureg qureg, int* targetQubits, enum pauliOpType* pauliCodes, int numTargets, Qureg workspace);
 ...
 * @author Tyson Jones
 */
qreal QUESTAPI calcExpecPauliSum(Qureg qureg, enum pauliOpType* allPauliCodes, qreal* termCoeffs, int numSumTerms, Qureg workspace);
 ...
 * @author Tyson Jones
 */
qreal QUESTAPI calcExpecPauliHamil(Qureg qureg, PauliHamil hamil, Qureg workspace);
 ...
 * @author Tyson Jones
 */
void QUESTAPI twoQubitUnitary(Qureg qureg, int targetQubit1, int targetQubit2, ComplexMatrix4 u);
 ...
 * @author Tyson Jones
 */
void QUESTAPI controlledTwoQubitUnitary(Qureg qureg, int controlQubit, int targetQubit1, int targetQubit2, ComplexMatrix4 u);
 ...
 * @author Tyson Jones
 */
void QUESTAPI multiControlledTwoQubitUnitary(Qureg qureg, int* controlQubits, int numControlQubits, int targetQubit1, int targetQubit2, ComplexMatrix4 u);
 ...
 * @author Tyson Jones
 */
void QUESTAPI multiQubitUnitary(Qureg qureg, int* targs, int numTargs, ComplexMatrixN u);
 ...
 * @author Tyson Jones
 */
void QUESTAPI controlledMultiQubitUnitary(Qureg qureg, int ctrl, int* targs, int numTargs, ComplexMatrixN u);
 ...
 * @author Tyson Jones
 */
void QUESTAPI multiControlledMultiQubitUnitary(Qureg qureg, int* ctrls, int numCtrls, int* targs, int numTargs, ComplexMatrixN u);
 ...
 * @author Tyson Jones (refactored, doc)
 */
void QUESTAPI mixKrausMap(Qureg qureg, int target, ComplexMatrix2 *ops, int numOps);
 ...
 * @author Tyson Jones (refactored, doc)
 */
void QUESTAPI mixTwoQubitKrausMap(Qureg qureg, int target1, int target2, ComplexMatrix4 *ops, int numOps);
 ...
 * @author Balint Koczor
 */
void QUESTAPI mixMultiQubitKrausMap(Qureg qureg, int* targets, int numTargets, ComplexMatrixN* ops, int numOps);
 ...
 */
void QUESTAPI mixNonTPKrausMap(Qureg qureg, int target, ComplexMatrix2 *ops, int numOps);
 ...
 * @author Balint Koczor (backend code)
 */
void QUESTAPI mixNonTPTwoQubitKrausMap(Qureg qureg, int target1, int target2, ComplexMatrix4 *ops, int numOps);
 ...
 * @author Balint Koczor (backend code)
 */
void QUESTAPI mixNonTPMultiQubitKrausMap(Qureg qureg, int* targets, int numTargets, ComplexMatrixN* ops, int numOps);
 ...
 * @author Tyson Jones (refactored, doc)
 */
qreal QUESTAPI calcHilbertSchmidtDistance(Qureg a, Qureg b);
 ...
 * @author Tyson Jones
 */
void QUESTAPI setWeightedQureg(Complex fac1, Qureg qureg1, Complex fac2, Qureg qureg2, Complex facOut, Qureg out);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyPauliSum(Qureg inQureg, enum pauliOpType* allPauliCodes, qreal* termCoeffs, int numSumTerms, Qureg outQureg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyPauliHamil(Qureg inQureg, PauliHamil hamil, Qureg outQureg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyTrotterCircuit(Qureg qureg, PauliHamil hamil, qreal time, int order, int reps);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyMatrix2(Qureg qureg, int targetQubit, ComplexMatrix2 u);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyMatrix4(Qureg qureg, int targetQubit1, int targetQubit2, ComplexMatrix4 u);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyMatrixN(Qureg qureg, int* targs, int numTargs, ComplexMatrixN u);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyMultiControlledMatrixN(Qureg qureg, int* ctrls, int numCtrls, int* targs, int numTargs, ComplexMatrixN u);
 ...
 * E.g. in C
 * @code
void QUESTAPI invalidQuESTInputError(const char* errMsg, const char* errFunc) {
 ...
 * extern "C":
 * @code
extern "C" void QUESTAPI invalidQuESTInputError(const char* errMsg, const char* errFunc) {
...
void QUESTAPI invalidQuESTInputError(const char* errMsg, const char* errFunc);
 ...
 /// \cond HIDDEN_SYMBOLS
/** Creates a ComplexMatrixN struct QUESTAPI with .real and .imag arrays kept entirely 
 * in the stack. 
 ...
 * @returns a ComplexMatrixN struct QUESTAPI with stack-stored .real and .imag arrays,
...
#ifndef __cplusplus
/** Creates a ComplexMatrixN struct QUESTAPI which lives in the stack and so does not 
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyPhaseFunc(Qureg qureg, int* qubits, int numQubits, enum bitEncoding encoding, qreal* coeffs, qreal* exponents, int numTerms);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyPhaseFuncOverrides(Qureg qureg, int* qubits, int numQubits, enum bitEncoding encoding, qreal* coeffs, qreal* exponents, int numTerms, long long int* overrideInds, qreal* overridePhases, int numOverrides);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyMultiVarPhaseFunc(Qureg qureg, int* qubits, int* numQubitsPerReg, int numRegs, enum bitEncoding encoding, qreal* coeffs, qreal* exponents, int* numTermsPerReg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyMultiVarPhaseFuncOverrides(Qureg qureg, int* qubits, int* numQubitsPerReg, int numRegs, enum bitEncoding encoding, qreal* coeffs, qreal* exponents, int* numTermsPerReg, long long int* overrideInds, qreal* overridePhases, int numOverrides);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyNamedPhaseFunc(Qureg qureg, int* qubits, int* numQubitsPerReg, int numRegs, enum bitEncoding encoding, enum phaseFunc functionNameCode);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyNamedPhaseFuncOverrides(Qureg qureg, int* qubits, int* numQubitsPerReg, int numRegs, enum bitEncoding encoding, enum phaseFunc functionNameCode, long long int* overrideInds, qreal* overridePhases, int numOverrides);
 ...
 * @author Richard Meister (shifted functions)
 */
void QUESTAPI applyParamNamedPhaseFunc(Qureg qureg, int* qubits, int* numQubitsPerReg, int numRegs, enum bitEncoding encoding, enum phaseFunc functionNameCode, qreal* params, int numParams);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyParamNamedPhaseFuncOverrides(Qureg qureg, int* qubits, int* numQubitsPerReg, int numRegs, enum bitEncoding encoding, enum phaseFunc functionNameCode, qreal* params, int numParams, long long int* overrideInds, qreal* overridePhases, int numOverrides);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyFullQFT(Qureg qureg);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyQFT(Qureg qureg, int* qubits, int numQubits);
 ...
 * @author Tyson Jones
 */
void QUESTAPI applyProjector(Qureg qureg, int qubit, int outcome);
