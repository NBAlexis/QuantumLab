...
TEST_CASE( "createDiagonalOpFromPauliHamilFile", "[data_structures]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        SECTION( "edge cases" ) {
            ...
            qreal coeffs[] = {.1};
            pauliOpType* codes = (pauliOpType*)alloca(minNumQb * sizeof(pauliOpType));
...
TEST_CASE( "createPauliHamilFromFile", "[data_structures]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        SECTION( "general" ) {
            ...
            enum pauliOpType* paulis = (enum pauliOpType*)alloca(numPaulis * sizeof(enum pauliOpType));
...
TEST_CASE( "initDiagonalOp", "[data_structures]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        qreal* reals = (qreal*)alloca(len * sizeof(qreal));
        qreal* imags = (qreal*)alloca(len * sizeof(qreal));
        long long int n;
        for (n=0; n<len; n++) {
            reals[n] = (qreal)    n;
...
TEST_CASE( "initPauliHamil", "[data_structures]" ) {
    ...
    SECTION( "input validation" ) {
        ...
        SECTION( "Pauli codes" ) {
            ...
            qreal* coeffs = (qreal*)alloca(numTerms * sizeof(qreal));
            enum pauliOpType* codes = (enum pauliOpType*)alloca(numCodes * sizeof(enum pauliOpType));
