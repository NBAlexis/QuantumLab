...
TEST_CASE( "calcExpecPauliProd", "[calculations]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        pauliOpType* paulis = (pauliOpType*)alloca(numTargs * sizeof(pauliOpType));
...
TEST_CASE( "calcExpecPauliSum", "[calculations]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        pauliOpType* paulis = (pauliOpType*)alloca(totNumCodes * sizeof(pauliOpType));
        qreal* coeffs = (qreal*)alloca(numSumTerms * sizeof(qreal));
    ...
    SECTION( "input validation" ) {
        ...
        SECTION( "pauli codes" ) {
            ...
            int numSumTerms = 3;
            qreal* coeffs = (qreal*)alloca(numSumTerms * sizeof(qreal));
            pauliOpType* codes = (pauliOpType*)alloca(numSumTerms * NUM_QUBITS * sizeof(pauliOpType));
...
TEST_CASE( "calcProbOfAllOutcomes", "[calculations]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        qreal* probs = (qreal*)alloca(numOutcomes * sizeof(qreal));
