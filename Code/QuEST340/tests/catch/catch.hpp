...
#define INTERNAL_CATCH_THROWS_STR_MATCHES( macroName, resultDisposition, matcher, ... ) \
    do { \
        ...
        { \
            printf("catchAssertionHandler.allowThrows() = false\n"); \
            catchAssertionHandler.handleThrowingCallSkipped(); \
        } \
        INTERNAL_CATCH_REACT( catchAssertionHandler ) \
    } while( false )
...
namespace Catch {
    ...
    void RunContext::handleExpr(
        ...
        if( result ) {
            if (!m_includeSuccessfulResults) {
                ...
                printf("reportExpr result = true \n");
                reportExpr(info, ResultWas::Ok, &expr, negated);
            }
        }
        else {
            //printf("reportExpr result = false \n");
    ...
    void RunContext::handleNonExpr(
        ...
        //printf(" RunContext::handleNonExpr\n");
        m_lastAssertionInfo = info;
...
#define TEST_CASE_PRINT( ... ) INTERNAL_CATCH_TESTCASE( __VA_ARGS__ ) { printf(#__VA_ARGS__ ); printf("\n");
