...
TEST_CASE( "mixMultiQubitKrausMap", "[decoherence]" ) {
    ...
    SECTION( "input validation" ) {
        ...
        SECTION( "number of operators" ) {
            ...
            int* targs = (int*)alloca(numTargs * sizeof(int));
        ...
        SECTION( "initialisation of operators" ) {
            ...
            ComplexMatrixN* ops = (ComplexMatrixN*)alloca(numOps * sizeof(ComplexMatrixN));
            for (int i=0; i<numOps; i++)
...
TEST_CASE( "mixPauli", "[decoherence]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        REQUIRE( areEqual(qureg, ref, 1E3 * REAL_EPS) );
    }
    SECTION( "input validation" ) {
...
TEST_CASE( "mixKrausMap", "[decoherence]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        ComplexMatrix2* ops = (ComplexMatrix2*)alloca(numOps * sizeof(ComplexMatrix2));
        for (int i=0; i<numOps; i++)
...
TEST_CASE( "mixTwoQubitKrausMap", "[decoherence]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        ComplexMatrix4* ops = (ComplexMatrix4*)alloca(numOps * sizeof(ComplexMatrix4));
        for (int i=0; i<numOps; i++)
            ops[i] = toComplexMatrix4(matrs[i]);
