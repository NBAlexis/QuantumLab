...
TEST_CASE( "applyMultiVarPhaseFunc", "[operators]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        int* numQubitsPerReg = (int*)alloca(numRegs * sizeof(int));
        ...
        int* numTermsPerReg = (int*)alloca(numRegs * sizeof(int));
        int numTermsTotal = 0;
        ...
        int flatInd = 0;
        qreal* coeffs = (qreal*)alloca(numTermsTotal * sizeof(qreal));
        qreal* expons = (qreal*)alloca(numTermsTotal * sizeof(qreal));
        for (int r=0; r<numRegs; r++) {
...
TEST_CASE( "applyMultiVarPhaseFuncOverrides", "[operators]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        long long int* overrideInds = (long long int*)alloca(numOverrides * numRegs * sizeof(long long int));
        flatInd = 0;
        ...
        qreal* overridePhases = (qreal*)alloca(numOverrides * sizeof(qreal));
        for (int v=0; v<numOverrides; v++)
...
TEST_CASE( "applyNamedPhaseFunc", "[operators]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        qreal** regVals = (qreal**)alloca((1 << totalNumQubits) * sizeof(qreal*));
        for (long long int i = 0; i < (1 << totalNumQubits); i++)
        {
            regVals[i] = (qreal*)alloca(numRegs * sizeof(qreal));
        }
...
TEST_CASE( "applyParamNamedPhaseFunc", "[operators]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        SECTION( "SCALED_INVERSE_SHIFTED_NORM" ) {
            ...
            qreal* params = (qreal*)alloca(numParams * sizeof(qreal));
    ...
    SECTION( "input validation" ) {
        ...
        SECTION( "phase function parameters" ) {
            ...
            qreal* params = (qreal*)alloca((numRegs + 3) * sizeof(qreal));
...
TEST_CASE( "applyPauliSum", "[operators]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        qreal* coeffs = (qreal*)alloca(numTerms * sizeof(qreal));
        pauliOpType* paulis = (pauliOpType*)alloca(numPaulis * sizeof(pauliOpType));
...
TEST_CASE( "applyPhaseFunc", "[operators]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        qreal* coeffs = (qreal*)alloca(numTerms * sizeof(qreal));
        qreal* expons = (qreal*)alloca(numTerms * sizeof(qreal));
...
TEST_CASE( "applyPhaseFuncOverrides", "[operators]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        // randomise each override index (uniqueness isn't checked)
        long long int* overrideInds = (long long int*)alloca(numOverrides * sizeof(long long int));
        overrideInds[0] = 0LL;
    ...
    SECTION( "input validation" ) {
        ...
        SECTION( "fractional exponent" ) {
            ...
            long long int* overrideInds = (long long int*)alloca(numNegs * sizeof(long long int));
            qreal* overridePhases = (qreal*)alloca(numNegs * sizeof(qreal));
