...
TEST_CASE( "initStateFromAmps", "[state_initialisations]" ) {
    ...
    SECTION( "correctness" ) {
        ...
        SECTION( "state-vector" ) {
            ...
            qreal* ampsRe = (qreal*)alloca(vec.numAmpsTotal * sizeof(qreal));
            qreal* ampsIm = (qreal*)alloca(vec.numAmpsTotal * sizeof(qreal));
            for (size_t i=0; i<vecRef.size(); i++) {
        ...
        SECTION( "density-matrix" ) {
            ...
            qreal* ampsRe = (qreal*)alloca(mat.numAmpsTotal * sizeof(qreal));
            qreal* ampsIm = (qreal*)alloca(mat.numAmpsTotal * sizeof(qreal));
...
TEST_CASE( "setAmps", "[state_initialisations]" ) {
    ...
    qreal* reals = (qreal*)alloca(maxInd * sizeof(qreal));
    qreal* imags = (qreal*)alloca(maxInd * sizeof(qreal));
...
TEST_CASE( "setDensityAmps", "[state_initialisations]" ) {
    ...
    qreal* reals = (qreal*)alloca(matr.numAmpsTotal * sizeof(qreal));
    qreal* imags = (qreal*)alloca(matr.numAmpsTotal * sizeof(qreal));
