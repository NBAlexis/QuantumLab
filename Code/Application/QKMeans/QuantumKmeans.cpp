...
void TestKNNAnsatz(CParameters& params)
{
    ...
    QLQuantumKmeans::KNNAnsatz(sAnsatz, sTestPoints, sTestingClusters, sHitSave, ansatzQubit, uiMeasureBits, bIsAdap, uiAnsatzLevel, ansatzStyle, ansatzSingleLayer, ansatzLayer, uiRepeat);
}
...
void TestKNNAnsatzSE(CParameters& params)
{
    ...
    QLQuantumKmeans::KNNAnsatzSE(sAnsatz, sTestPoints, sTestingClusters, sHitSave, ansatzQubit, uiMeasureBits, uiEncodeBits, bIsAdap, uiAnsatzLevel, ansatzStyle, ansatzSingleLayer, ansatzLayer, simpleencodeStyle, simpleencodeLayer, uiRepeat);
}
...
void TestKNNSE(CParameters& params)
{
    ...
    QLQuantumKmeans::KNNSE(sPoints, sTestPoints, sTestingClusters, uiMeasureBits, uiEncodeBits, simpleencodeStyle, simpleencodeLayer, uiRepeat);
}
