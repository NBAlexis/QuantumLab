...
#define _QL_FLT_MIN_ 1E-50   //When smaller than this, sqrt, divide will become nan

#define _QL_FLT_DECIMAL_DIG  17                      // # of decimal digits of rounding precision
#define _QL_FLT_DIG          15                      // # of decimal digits of precision
#define _QL_FLT_EPSILON      2.2204460492503131e-016 // smallest such that 1.0+DBL_EPSILON != 1.0
#define _QL_FLT_HAS_SUBNORM  1                       // type does support subnormal numbers
#define _QL_FLT_MANT_DIG     53                      // # of bits in mantissa
#define _QL_FLT_MAX          1.7976931348623158e+308 // max value
#define _QL_FLT_MAX_10_EXP   308                     // max decimal exponent
#define _QL_FLT_MAX_EXP      1024                    // max binary exponent
#define _QL_FLT_MIN          2.2250738585072014e-308 // min positive value
#define _QL_FLT_MIN_10_EXP   (-307)                  // min decimal exponent
#define _QL_FLT_MIN_EXP      (-1021)                 // min binary exponent
#define _QL_FLT_RADIX        2                       // exponent radix
#define _QL_FLT_TRUE_MIN     4.9406564584124654e-324 // min positive value

#else

//They are not defined in GCC, so we define them explicitly
#define _QL_FLT_MIN_ 1E-22F   //When smaller than this, sqrt, divide will become nan

#define _QL_FLT_DECIMAL_DIG  9                       // # of decimal digits of rounding precision
#define _QL_FLT_DIG          6                       // # of decimal digits of precision
#define _QL_FLT_EPSILON      1.192092896e-07F        // smallest such that 1.0+FLT_EPSILON != 1.0
#define _QL_FLT_HAS_SUBNORM  1                       // type does support subnormal numbers
#define _QL_FLT_GUARD        0
#define _QL_FLT_MANT_DIG     24                      // # of bits in mantissa
#define _QL_FLT_MAX          3.402823466e+38F        // max value
#define _QL_FLT_MAX_10_EXP   38                      // max decimal exponent
#define _QL_FLT_MAX_EXP      128                     // max binary exponent
#define _QL_FLT_MIN          1.175494351e-38F        // min normalized positive value
#define _QL_FLT_MIN_10_EXP   (-37)                   // min decimal exponent
#define _QL_FLT_MIN_EXP      (-125)                  // min binary exponent
#define _QL_FLT_NORMALIZE    0
#define _QL_FLT_RADIX        2                       // exponent radix
#define _QL_FLT_TRUE_MIN     1.401298464e-45F        // min positive value
...
typedef double Real;
typedef cuDoubleComplex QLComplex;

#else

typedef float Real;
typedef cuComplex QLComplex;

#endif

__END_NAMESPACE

#endif//#ifndef _QLFLOAT_H_
