...
QLAPI const TCHAR* __GEmptyString = (const TCHAR*)((BYTE*)&_NullString + sizeof(CCStringData));
...
*
*/
CCString QLAPI operator+(const CCString& string1, const CCString& string2)
{
    CCString s;
...
*
*/
CCString QLAPI operator+(const CCString& string, const TCHAR* lpsz)
{
    CCString s;
...
*
*/
CCString QLAPI operator+(const TCHAR* lpsz, const CCString& string)
{
    CCString s;
...
*
*/
CCString QLAPI operator+(const CCString& string1, TCHAR ch)
{
    CCString s;
...
*
*/
CCString QLAPI operator+(TCHAR ch, const CCString& string)
{
    CCString s;
...
TCHAR* CCString::GetBuffer(INT nMinBufLength)
{
    ...
    if (GetData()->m_nRefs > 1 || nMinBufLength > GetData()->m_nAllocLength)
    {
        ...
        if (GetData() != _EmptyStringData && GetData()->m_nRefs < 0)
            printf(_T("Warning: GetBuffer on locked FString creates unlocked FString!\n"));
#endif
